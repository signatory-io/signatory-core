...
func HandleCall[E transport.Layout[M, Q, S, C], M transport.Message[Q, S, C], Q RPCRequest, S transport.Response[C], C codec.Codec](h *Handler, ctx context.Context, req *Q) (*S, error) {
	var enc E
